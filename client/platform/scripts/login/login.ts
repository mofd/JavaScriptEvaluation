...
module login {
    ...
    export class LoginController {
        constructor($scope:login.ILoginScope, $http:ng.IHttpService, dispatcher:dispatcher.IDispatcher,
...
define(['platform' /*, '../../../platform/scripts/dispatcher/dispatcher', '../../../platform/scripts/configuration/configuration'*/],
