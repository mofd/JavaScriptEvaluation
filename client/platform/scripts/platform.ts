...
define(['angular', 'angular-route', 'platform-login', 'platform-register'], function(angular:ng.IAngularStatic){
    angular.module('platform', ['ngRoute', 'platform-login', 'platform-register'])
